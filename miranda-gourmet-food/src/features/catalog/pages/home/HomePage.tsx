          ...
          <Row className="g-4">
            <Col lg={7}>
              ...
              <div className="row col-12 d-flex justify-content-center m-2 align-items-center">
                <div className={`col-6 m-1 ${styles.bullets} `}>
